...
ActiveRecord::Schema.define(version: 20150729102248) do
  ...
  create_table "users", force: true do |t|
    ...
    t.boolean  "allow_emails_from_followed_charities"
    t.boolean  "subscription_to_charity_square_emails"
    t.boolean  "suggestions"
    t.boolean  "tailored_ads"
    t.string   "primary_address1"
    t.string   "primary_address2"
    t.string   "primary_address3"
    t.string   "primary_address4"
    t.string   "primary_address_pin"
    t.string   "secondary_address1"
    t.string   "secondary_address2"
    t.string   "secondary_address3"
    t.string   "secondary_address4"
    t.string   "secondary_address_pin"
    t.string   "display_name"
    t.boolean  "UK_taxpayer"
    t.string   "ni_number"
    t.string   "banner_image"
    t.string   "profile_image"
    t.string   "instagram_field"
    t.string   "twitter_field"
    t.string   "youtube_field"
    t.string   "fb_field"
  end
