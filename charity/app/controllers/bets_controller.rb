class BetsController < ApplicationController
  ...
  def edit
    ...
    @charitypics=CharityMedia.where(:charityusersquare_id => @bet.id,:types => @bet.charitytype)
  ...
  def create
    ...
    @bet.active = true
     ...
     bet_media.bet_id = bet_id
     bet_media.save
     created_bet_id=bet_media.id
     path="#{Rails.root}/public/images/bet/#{created_bet_id}.jpg"
     temp.push path
     ...
     @update.save()
      ...
      Delayed::Job.enqueue(MailingJob.new(@bet.id, "bet"), -3, @time_enque.minutes.from_now.in_time_zone(@tz))
  ...
  def removepic
   @mediaid=params[:pic]
   File.delete("public/images/bet/#{params[:pic]}.jpg") if File.exist?("public/images/bet/#{params[:pic]}.jpg")
   CharityMedia.where(:picture=>@mediaid,:types=>'bet').first.destroy
   render :js => 'deleted'
  end 
